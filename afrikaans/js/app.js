...
// --- DATA ---
const VOCAB_DATA = [
    { id: 1, category: "The Basics", title: "Goeie more", english: ["good morning"], phonetic: "Khoy-uh mor-uh", mnemonic: "Go to the MOOR for a morning walk.", desc: "The 'G' in Afrikaans is a guttural sound, like clearing your throat.", xp: 50 },
    { id: 2, category: "The Basics", title: "Baie dankie", english: ["thank you very much", "thanks a lot", "thank you"], phonetic: "Buy-a dunky", mnemonic: "If you are grateful, BUY A DONKEY for someone.", desc: "Standard polite response. Use it often, boet!", xp: 50 },
    { id: 3, category: "Slang", title: "Lekker", english: ["nice", "good", "great", "tasty"], phonetic: "Lack-err", mnemonic: "I LACK A... good time? No, it's LEKKER!", desc: "The most versatile word. Food is lekker. The vibe is lekker. You are lekker.", xp: 75 },
    { id: 4, category: "Essentials", title: "Asseblief", english: ["please"], phonetic: "Ass-uh-bleef", mnemonic: "Ask for a LEAF, please.", desc: "Politeness gets you everywhere in South Africa.", xp: 75 },
    { id: 5, category: "Greetings", title: "Hoe gaan dit?", english: ["how are you", "how is it going", "how are you?"], phonetic: "Who khan dit", mnemonic: "WHO CAN DO IT? Hoe gaan dit?", desc: "Standard greeting. The reply is usually 'Goed, dankie' (Good, thanks).", xp: 100 },
    { id: 6, category: "Essentials", title: "Ja / Nee", english: ["yes / no", "yes no"], phonetic: "Ya / Nee-uh", mnemonic: "YA, I agree. Or NEAR (Nee) I don't.", desc: "Simple and essential. 'Ja-nee' is also a phrase meaning 'Sure' or 'I guess so'.", xp: 50 },
    { id: 7, category: "Food", title: "Braai", english: ["bbq", "barbecue", "grill"], phonetic: "Bry", mnemonic: "Don't CRY at the BRY (Braai).", desc: "It is NOT a BBQ. It is a Braai. It is a spiritual experience.", xp: 100 },
    { id: 8, category: "Animals", title: "Bobbejaan", english: ["baboon"], phonetic: "Bub-ba-yahn", mnemonic: "Bob and John are monkeys.", desc: "Watch out, they steal your food at Cape Point.", xp: 125 },
    { id: 9, category: "Slang", title: "Eish", english: ["wow", "oh no", "yikes", "oh dear"], phonetic: "Aysh", mnemonic: "Saying 'ACE' but you are disappointed.", desc: "Expresses resignation, surprise, or shock. Dropped your ice cream? Eish.", xp: 125 },
    { id: 10, category: "Slang", title: "Jol", english: ["party", "fun", "good time"], phonetic: "Yawl", mnemonic: "Y'ALL come to the party.", desc: "A party or having a good time. 'We had a lekker jol last night.'", xp: 150 }
];
                ...
                <div className="bg-white w-full max-w-md rounded-3xl shadow-xl p-8 text-center border border-orange-100 z-10 relative my-auto">
                    ...
                    {status !== 'success' ? (
                        <div className={`relative transition-all ${status === 'error' ? 'animate-shake' : ''}`}>
                            <input ref={inputRef} value={input} onChange={e => setInput(e.target.value)} onKeyDown={handleKeyDown} placeholder="Type english translation..." className={`w-full bg-[#F2F4F6] text-gray-900 text-lg font-medium p-4 rounded-xl border-2 focus:outline-none focus:ring-4 transition-all text-center ${status === 'error' ? 'border-red-400 ring-red-100' : 'border-transparent focus:border-[#D35400] focus:ring-orange-100'}`} />
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#FDF6E3]">
                ...
                {tab === 'learn' && (<Editor level={VOCAB_DATA.find(l => l.id === currentLevelId)} onNext={handleNextLevel} />)}
                {tab === 'profile' && (
