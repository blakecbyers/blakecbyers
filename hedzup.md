...
/**
 * HEADS UP: BLEVNECKED EDITION
 * * DEPLOYMENT INSTRUCTIONS:
 * 1. This app REQUIRES HTTPS to access DeviceOrientation on iOS.
 * 2. It will NOT work inside the preview iframe/canvas due to security sandboxing.
 * 3. Deploy to Vercel, Netlify, or GitHub Pages to test on a real device.
 */
    ...
    const handleStart = async () => {
        ...
        if (typeof DeviceOrientationEvent !== 'undefined' && typeof DeviceOrientationEvent.requestPermission === 'function') {
            try {
                ...
                // Usually happens if not HTTPS or not user triggered (though this is user triggered)
